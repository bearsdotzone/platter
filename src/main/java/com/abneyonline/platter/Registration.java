...
//    private static final DeferredRegister<ModDimension> DIMENSIONS = new DeferredRegister<>(ForgeRegistries.MOD_DIMENSIONS, MODID);
    ...
    public static final RegistryObject<BlockEntityType<OakPlatterTile>> oak_platter_tile = TILES.register("oak_platter_block", () -> BlockEntityType.Builder.of(OakPlatterTile::new, oak_platter_block.get())
                                                                                                                                                            .build(null));
    ...
    public static final RegistryObject<BlockEntityType<SprucePlatterTile>> spruce_platter_tile = TILES.register("spruce_platter_block", () -> BlockEntityType.Builder.of(SprucePlatterTile::new, spruce_platter_block.get())
                                                                                                                                                                     .build(null));
    ...
    public static final RegistryObject<BlockEntityType<BirchPlatterTile>> birch_platter_tile = TILES.register("birch_platter_block", () -> BlockEntityType.Builder.of(BirchPlatterTile::new, birch_platter_block.get())
                                                                                                                                                                  .build(null));
    ...
    public static final RegistryObject<BlockEntityType<JunglePlatterTile>> jungle_platter_tile = TILES.register("jungle_platter_block", () -> BlockEntityType.Builder.of(JunglePlatterTile::new, jungle_platter_block.get())
                                                                                                                                                                     .build(null));
    ...
    public static final RegistryObject<BlockEntityType<AcaciaPlatterTile>> acacia_platter_tile = TILES.register("acacia_platter_block", () -> BlockEntityType.Builder.of(AcaciaPlatterTile::new, acacia_platter_block.get())
                                                                                                                                                                     .build(null));
    ...
    public static final RegistryObject<BlockEntityType<DarkOakPlatterTile>> dark_oak_platter_tile = TILES.register("dark_oak_platter_block", () -> BlockEntityType.Builder.of(DarkOakPlatterTile::new, dark_oak_platter_block.get())
                                                                                                                                                                          .build(null));
    ...
    public static final RegistryObject<BlockEntityType<StonePlatterTile>> stone_platter_tile = TILES.register("stone_platter_block", () -> BlockEntityType.Builder.of(StonePlatterTile::new, stone_platter_block.get())
                                                                                                                                                                  .build(null));
    ...
    public static final RegistryObject<BlockEntityType<IronPlatterTile>> iron_platter_tile = TILES.register("iron_platter_block", () -> BlockEntityType.Builder.of(IronPlatterTile::new, iron_platter_block.get())
                                                                                                                                                               .build(null));
    ...
    public static final RegistryObject<BlockEntityType<GoldPlatterTile>> gold_platter_tile = TILES.register("gold_platter_block", () -> BlockEntityType.Builder.of(GoldPlatterTile::new, gold_platter_block.get())
                                                                                                                                                               .build(null));
    ...
    public static final RegistryObject<BlockEntityType<CrimsonPlatterTile>> crimson_platter_tile = TILES.register("crimson_platter_block", () -> BlockEntityType.Builder.of(CrimsonPlatterTile::new, crimson_platter_block.get())
                                                                                                                                                                        .build(null));
    ...
    public static final RegistryObject<BlockEntityType<WarpedPlatterTile>> warped_platter_tile = TILES.register("warped_platter_block", () -> BlockEntityType.Builder.of(WarpedPlatterTile::new, warped_platter_block.get())
                                                                                                                                                                     .build(null));
    ...
    public static final RegistryObject<BlockEntityType<MangrovePlatterTile>> mangrove_platter_tile = TILES.register("mangrove_platter_block", () -> BlockEntityType.Builder.of(MangrovePlatterTile::new, mangrove_platter_block.get())
                                                                                                                                                                           .build(null));
    ...
    public static final RegistryObject<BlockEntityType<BambooPlatterTile>> bamboo_platter_tile = TILES.register("bamboo_platter_block", () -> BlockEntityType.Builder.of(BambooPlatterTile::new, bamboo_platter_block.get())
                                                                                                                                                                     .build(null));
    ...
    public static final RegistryObject<BlockEntityType<CherryPlatterTile>> cherry_platter_tile = TILES.register("cherry_platter_block", () -> BlockEntityType.Builder.of(CherryPlatterTile::new, cherry_platter_block.get())
                                                                                                                                                                     .build(null));
